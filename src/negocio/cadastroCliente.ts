...
export default class CadastroCliente extends Cadastro{
    ...
    public cadastrar(): void {
        ...
        let dataDoc = this.entrada.receberTexto(`Data de Emissão dos Documentos(dd/mm/yyyy): `)
        ...
        let dataCadatro = this.entrada.receberTexto(`Insira a data deste Cadastro(dd/mm/yyyy): `)
        ...
        let cliente = new Cliente(nome, nomeSocial, genero, cpf, rg, telefone, dataEmissaoCad)
